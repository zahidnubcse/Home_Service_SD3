    ...
    <nav className="bg-white shadow-md w-full fixed top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-6 text-gray-800 font-medium">
            ...
            {/* <Link to="/booking" onClick={closeMenu} className="hover:text-primary">Bookings</Link> */}
            ...
            >
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-md w-48 z-10">
                  ...
                  <button className="block w-full px-4 py-2 text-left text-gray-800 hover:bg-gray-100">Logout</button>
                </div>
              )}
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md">
          ...
          {/* <Link to="/booking" onClick={closeMenu} className="block px-4 py-2 hover:bg-gray-100">Bookings</Link> */}
          ...
          <Link to="/login" onClick={closeMenu} className="block px-4 py-2 bg-teal-600 text-white text-center">Login</Link>
        </div>
      )}
    </nav>
  );
